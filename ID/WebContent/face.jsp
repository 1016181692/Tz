...
<html>
	<head>
			...
			<style type="text/css">
				*{margin:0;padding:0;}
				...
				/*banner start*/
				.banner{width:100%;height:470px;background:url("img/001.png") top center;background-size:cover;}
				/*end banner*/
 ...
 <body>
				...
				<div class="photo">
					<div class="p_box">
						<img src="${empty fileName ? 'img/002.png' : fileName}"  id="path"   alt="刘大帅"   width="505">
